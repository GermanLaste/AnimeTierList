...
export function Header({ onAddRow, onReset, onExport, user }) {
  return (
...
<div className="w-px h-6 bg-gray-700 mx-1"></div> {/* Separador opcional */}
        {/* BOTONES DE ACCIÓN */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center bg-gray-800/50 p-1.5 rounded-xl border border-gray-700/50 backdrop-blur-sm">
            {user ? (
              ...
              /* ESTADO: DESCONECTADO (Botón Google Dark) */
              <button
                onClick={handleLogin}
          ...
          {/* ISLA 2: HERRAMIENTAS (Añadir, Reset, Exportar) */}
